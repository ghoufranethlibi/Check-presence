  ...
  Future<void> _showForgotPasswordDialog() async {
    ...
    await showDialog<void>(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(settings.t('reset_password')),
        content: TextField(
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              messenger.showSnackBar(SnackBar(
                content: Text(err ?? settings.t('reset_email_sent')),
                backgroundColor: err == null ? Colors.green : Colors.red,
              ));
            },
            child: Text(settings.t('send_reset_link')),
          ),
        ],
      ),
    );
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Text(settings.t('smart_presence'),
                      style: TextStyle(
                          fontSize: 13,
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: TextButton(
                            ...
                            child: Text(settings.t('forgot_password'),
                                style: const TextStyle(
