  ...
  void _filter() {
    ...
    setState(() {
      _filtered = _all.where((e) =>
          ...
          e.id.toLowerCase().contains(q)).toList();
    });
  }
  ...
  Future<void> _delete(Employee emp) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        title: Text(settings.t('confirm_delete')),
        content: Text('${settings.t('delete_confirm_msg')} ${emp.name} ?'),
        actions: [
          TextButton(
      ...
      body: Column(children: [
        Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText:   settings.t('search_employee'),
        ...
        Padding(
          ...
          child: Align(
            ...
            child: Text('${_filtered.length} ${settings.t('employees')}',
