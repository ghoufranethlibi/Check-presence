...
class _MyAttendanceScreenState extends State<MyAttendanceScreen> {
  ...
  Future<void> _load() async {
    ...
    if (auth.currentEmployee != null) {
      final data = await svc.getEmployeeHistory(auth.currentEmployee!.id);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(settings.t('attendance_history')),
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          decoration: BoxDecoration(
            color:        isToday
                ? const Color(0xFF1E3A8A) : Colors.grey.shade200,
